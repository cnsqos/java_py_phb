...
public class If {
	public static void main(String[] args) {
		...
		//정수형 변수 x가 10보다 크고 20보다 작을 때 true인 조건식
		...
		//문자형 변수가 ch가 'x' 또는 'X'일 때 true인 조건식
		...
		//if else
		//if(조건식){조건식이 참일때 실행할 명령} else {조건식이 거짓을 때 실행할 명령}
		...
		//} else if(조건식4){
		// 조건식 1,2,3이 거짓이고 4가 참일 때
		//} else {어느 조건도 맞지 않을 때 실행할 명령}
